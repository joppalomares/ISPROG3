...
{
    public partial class professorreportviewer : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                String sql = "Select * FROM tableProfessor";
                ...
                rpt.Load(Server.MapPath("Crystalreportforprofessor.rpt"));
                rpt.SetDatabaseLogon("sa", "yugioh", @"JOP-PC\SQLEXPRESS", "ISAttandaceManagementSystem");

                rpt.SetDataSource(dt);

                crvprofessor.ReportSource = rpt;
        ...
        protected void crvprofessor_Init(object sender, EventArgs e)
        {
